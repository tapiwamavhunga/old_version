<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light ">
    <div class="container">
      <a class="navbar-brand mr-lg-5 d-none" href="/">
        <img src="{{ config('global.site_logo_dark') }}">
      </a>
      <a class="navbar-brand mr-lg-5 " href="/">
        <img src="{{ asset('agris') }}/agris_logo.png">
      </a>
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
        <div class="navbar-collapse-header">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="/">
                <img class="d-none" src="{{ config('global.site_logo') }}">
                <img src="{{ asset('agris') }}/agris_logo.png">
              </a>
            </div>
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto text-info">
          <li class="nav-item text-default" data-toggle="collapse" data-target=".navbar-collapse.show">
            <a data-scroll href="#features" class="nav-link text-default">{{ __('whatsapp.features') }}</a>
          </li>
          @if(!config('global.facebook') && !config('global.instagram'))
            <li class="nav-item " data-toggle="collapse" data-target=".navbar-collapse.show">
              <a data-scroll href="#product" class="nav-link text-default" >{{ __('whatsapp.product') }}</a>
            </li>
          @endif
          <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show">
            <a data-scroll href="#pricing" class="nav-link text-default" >{{ __('whatsapp.pricing') }}</a>
          </li>
          <li class="nav-item" data-toggle="collapse" data-target=".navbar-collapse.show">
            <a data-scroll href="#demo" class="nav-link text-default">{{ __('whatsapp.demo') }}</a>
          </li>
            ...
            <li class="nav-item dropdown">
              <a href="#" class="nav-link" data-toggle="dropdown" role="button">
                ...
                @foreach ($availableLanguages as $short => $lang)
                  @if(strtolower($short) == strtolower($locale))<span class="nav-link-inner--text text-default">{{ $lang }}</span>@endif
                @endforeach
              </a>
              <div class="dropdown-menu">
                @foreach ($availableLanguages as $short => $lang)
                  <a href="/{{ strtolower($short) }}" class="dropdown-item text-default">{{ $lang }}</a>
                @endforeach
              </div>
            </li>
          @endif
          ...
          <li class="nav-item d-lg-block ml-lg-2">
            <a class="btn btn-success btn-icon" href="/login">
                @auth()
